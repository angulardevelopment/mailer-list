...
- Interactive design to Register for Mailer List
...
- where users can be added to a mailer list.
- A visitor should be able to add his email to the mailing list
- The Home Page must have a Register to Mailer List button. As soon as anyone registers, a beautifully designed html mail should go. 
- Used free html welcome mail template.
- Login functionality for the admin to login. Admin should be able to trigger the mail to all users in the database at any time. There must be a WYSIWYG Editor embedded so that, admin can send mail with a custom subject and content to all users in the mailer list.
